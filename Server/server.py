...
def print_banner():
    ...
    print("\n               - Comandi curl:")
    print("                      - curl -X GET http://localhost:5000/api/reports/health")
    print("                      - curl -X GET http://localhost:5000/api/reports/formats")
    print("                      - curl -X POST http://localhost:5000/api/reports/generate \\")
    print("                             -F 'birtFile=@/path/to/report.rptdesign' \\")
    print("                             -F 'jsonApiUrl=http://example.com/api/data' \\")
    print("                             -F 'format=PDF'")
